...
public class Presentation implements jabberpoint.model.PresentationSubject {
	private String showTitle; // title of the presentation
	private ArrayList<Slide> showList = null; // an ArrayList with Slides
	private int currentSlideNumber = 0; // the slidenummer of the current Slide
	private List<jabberpoint.model.PresentationObserver> observers = new ArrayList<>(); // list of observers
	...
	public Presentation(SlideViewerComponent slideViewerComponent) {
		if (slideViewerComponent instanceof jabberpoint.model.PresentationObserver) {
			registerObserver((jabberpoint.model.PresentationObserver) slideViewerComponent);
		}
		clear();
	}
	...
	@Override
	public void registerObserver(jabberpoint.model.PresentationObserver observer) {
	...
	@Override
	public void removeObserver(jabberpoint.model.PresentationObserver observer) {
	...
	public void notifyObservers() {
		...
		for (jabberpoint.model.PresentationObserver observer : observers) {
	...
	@Override
	public void addObserver(jabberpoint.model.Observer observer) {
		if (observer instanceof jabberpoint.model.PresentationObserver) {
			registerObserver((jabberpoint.model.PresentationObserver) observer);
		}
	}

	@Override
	public void removeObserver(jabberpoint.model.Observer observer) {
		if (observer instanceof jabberpoint.model.PresentationObserver) {
			removeObserver((jabberpoint.model.PresentationObserver) observer);
		}
	}
}
