...
public class PresentationTest {
    ...
    void testSlideNavigation() {
        ...
        assertEquals(0, presentation.getSlideNumber(), "After prevSlide, slide number should be 0");
        
        presentation.prevSlide();
        assertEquals(0, presentation.getSlideNumber(), "After prevSlide beyond first slide, slide number should remain 0");
    }
